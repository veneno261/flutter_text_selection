...
// viewport.
const double _kToolbarScreenPadding = 4.0;
...
class _TextSelectionToolbarState extends State<TextSelectionToolbar> {
  ...
  Widget build(BuildContext context) {
    ...
    // If items length is smaller than three, build a simple widget
    if(items.length <= 3) {
      return Material(
        elevation: 1.0,
        child: Container(
    ...
    items.insert( 3 ,
      Padding(
        ...
        child: GestureDetector(
          onTap: () => setState(() => _moreItemMode = true),
          child: Icon(IconData(0xe5d4, fontFamily: 'MaterialIcons')),
        ),
      )
    );
    ...
    items.add(
      GestureDetector(
        onTap: () => setState(() => _moreItemMode = false),
        child: Container(
          width: 90,
          child: Align(
            ...
            child: SizedBox(
              width: 30,
              height: _kToolbarHeight,
              child: Icon(IconData(0xe5c4, fontFamily: 'MaterialIcons')),
            ),
          ),
        ),
      )
    ...
    return Material(
      elevation: 1.0,
      child: Container(
        width: _moreItemMode ? 140 : null,
        height: _moreItemMode ? null : _kToolbarHeight,
        child: _moreItemMode ?
          Column(
            mainAxisSize: MainAxisSize.min,
